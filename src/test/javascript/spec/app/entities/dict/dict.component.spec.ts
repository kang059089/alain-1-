...
import { DictComponent } from 'app/entities/dict/dict.component';
import { DictService } from 'app/entities/dict/dict.service';
import { Dict } from 'app/shared/model/dict.model';

describe('Component Tests', () => {
    describe('Dict Management Component', () => {
        let comp: DictComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(DictComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.dicts[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
