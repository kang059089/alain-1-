...
public class RoleResourceIntTest {
    ...
    public void setup() {
        ...
        final RoleResource roleResource = new RoleResource(roleRepository, roleService);
    ...
    public void createRole() throws Exception {
        ...
        assertThat(testRole.getAcl()).isEqualTo(DEFAULT_ACL);
    }
    ...
    public void updateRole() throws Exception {
        ...
        assertThat(testRole.getAcl()).isEqualTo(UPDATED_ACL);
    }
