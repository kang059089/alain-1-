...
import { DictTypeComponent } from 'app/entities/dict-type/dict-type.component';
...
describe('Component Tests', () => {
    describe('DictType Management Component', () => {
        let comp: DictTypeComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(DictTypeComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.dictTypes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
